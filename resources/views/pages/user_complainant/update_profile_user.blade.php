                                ...
                                <div class="content">
                                    <div class="content__cover">
                                        <div class="content__avatar"
                                            style="background-image: url('{{ Auth::user()->profile_photo ? asset('storage/' . Auth::user()->profile_photo) : asset('default_profile_photo/default.jpg') }}');">
                                        </div>
                                        <div class="content__bull">
                                            <span></span><span></span><span></span><span></span><span></span>
                                        </div>
                                    </div>
                                    <div class="content__actions"><a href="/my_ticket">
                                            ...
                                            <span>Home</span></a>
                                        {{-- <a href="#" id="changeProfilePhotoBtn">
                                            ...
                                            </svg><span>Change Profile Photo</span>
                                        </a> --}}
                                    </div>
                                    <div class="content__title">
                                        <h1>{{ $user->name }}</h1><span>{{ $user->role }}</span>
                                    </div>
                                    ...
                                    <div class="content__list">
                                        ...
                                        @endif
                                        <form action="{{ route('user.redeem_code') }}" method="post" class="forms-sample">
                                            @csrf
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Premium Code"
                                                        id="premiumCode" name="premiumCode">
                                    ...
                                    <div class="content__list">
                                        <form class="forms-sample" action="{{ route('user.update.password') }}"
                                            ...
                                            <div class="content__button">
                                                <button type="submit" aria-placeholder="Change Password"
                ...
                @if (session('sweetAlert'))
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            const sweetAlert = @json(session('sweetAlert'));
